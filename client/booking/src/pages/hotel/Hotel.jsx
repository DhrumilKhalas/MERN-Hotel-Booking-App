...
const Hotel = () => {
  ...
  return (
    <div id="hotellastpagediv">
          ...
          <div className="hotelWrapper">
                    ...
                    <div className="hotelDetails">
                            ...
                            <div className="hotelDetailsPrice">
                                <h1 className="hotelDetailsPriceh1">Perfect for a {days}-night stay!</h1>
                                ...
                                <button onClick={handleClick} className="hotelDetailsPricebtn">Reserve or Book Now!</button>
                            </div>
      ...
      {openModal && <div className="bookingmodal"><Reserve setOpen={setOpenModal} hotelId={id} className="bookingmodalinner"/></div>}
